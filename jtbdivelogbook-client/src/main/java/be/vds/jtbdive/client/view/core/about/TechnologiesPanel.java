...
public class TechnologiesPanel extends JPanel {
	...
	protected static final Syslog LOGGER = Syslog
			.getLogger(TechnologiesPanel.class);
	...
	private void init() {
		...
		for (Technologies t : Technologies.values()) {
			...
			GridBagLayoutManager.addComponent(this, c, gc, 0, y, 1, 1, 0, 0,
					GridBagConstraints.NONE, GridBagConstraints.CENTER);

			GridBagLayoutManager.addComponent(this, new JLabel(t.getName()),
					gc, 1, y, 1, 1, 1, 0, GridBagConstraints.HORIZONTAL,
					GridBagConstraints.WEST);

			c = createLicenceComponent(t);
			GridBagLayoutManager.addComponent(this, c, gc, 2, y, 1, 1, 0, 0,
					GridBagConstraints.NONE, GridBagConstraints.EAST);
			y++;
			
			GridBagLayoutManager.addComponent(this, new JSeparator(), gc, 0, y, 3, 1, 1, 0,
					GridBagConstraints.HORIZONTAL, GridBagConstraints.EAST);
			y++;
		}

		GridBagLayoutManager.addComponent(this, Box.createVerticalGlue(), gc,
				1, y, 1, 1, 0, 1, GridBagConstraints.VERTICAL,
		...
		if (licencePath != null) {
			JButton infoBtn = new JButton(new AbstractAction() {
				...
				public void actionPerformed(ActionEvent e) {
					URI uri;
					try {
						uri = ResourceManager.getInstance()
								.getLicenceURL(licencePath).toURI();
						String content = FileUtilities.readFileContent(uri);
						LicenceDialog ld = new LicenceDialog(t.getName(),
								content);
	...
	private Component createIconComponent(Technologies t) {
		...
		if (iconName != null) {
			return new JLabel(ResourceManager.getInstance().getImageIcon(
					"logos/" + iconName));
		}
...
enum Technologies {
	...
	JAVA(1, "Java", "java_24.png", null), //
	DOCKING_FRAMES(2, "Docking frames", null, null), //
	SWINGX(3, "SwingX", null, null), //
	JASPER_REPORTS(4, "JasperReports", "japserreports_24.png",
			"jasperreport.txt"), //
	JFREECHART(5, "JFreeChart", null, null), //
	LOG4J(6, "Log4j", "log4j_24.png", null), //
	RXTX(7, "rxtx", null, null), //
	ITEXT(8, "iText", null, null), //
	;
