...
public class StatYAxisNumberOfDivePanel extends WizardPanel {

	private static final long serialVersionUID = 893192381965320355L;


	@Override
	public String getMessage() {
		return i18n.getString("wizard.stat.numberofdives");
	}
