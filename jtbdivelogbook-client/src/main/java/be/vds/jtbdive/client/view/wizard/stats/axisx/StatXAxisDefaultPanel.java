...
public class StatXAxisDefaultPanel extends WizardPanel {

	private static final long serialVersionUID = -4787969496498152217L;

	public StatXAxisDefaultPanel() {
		super();
	}

	@Override
	public String getMessage() {
		return i18n.getString("wizard.stat.axis.x");
	}
