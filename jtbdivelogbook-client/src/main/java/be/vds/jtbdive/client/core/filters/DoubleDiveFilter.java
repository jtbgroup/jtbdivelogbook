...
public class DoubleDiveFilter extends DiveFilter {

	public DoubleDiveFilter(DiveFilterType filterType) {
		super(filterType);
	...
	public double getDiveCriteria(Dive dive) {
		return (Double) diveFilterType.getInspector().getFilterParameter(dive);
	}
