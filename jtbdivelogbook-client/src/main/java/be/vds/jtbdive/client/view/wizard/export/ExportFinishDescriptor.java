...
public class ExportFinishDescriptor extends WizardPanelDescriptor {

	public static final String IDENTIFIER = "EXPORT_FINISH_PANEL";
	private static String backIdentifier;
	private ExportFinishPanel panel;

	public ExportFinishDescriptor() {
		panel = new ExportFinishPanel();
