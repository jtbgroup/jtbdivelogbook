...
public class FinsMaterialPanel extends AbstractMaterialPanel {

	private static final long serialVersionUID = -6915906280043888163L;

	public FinsMaterialPanel() {
		super();
	}
	...
	protected JComponent createSpecific() {
		...
		int y = 0;
		GridBagLayoutManager.addComponent(content, createSizeLabel(), gc, 0, y, 1,
				1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		GridBagLayoutManager
				.addComponent(content, createSizeComponent(), gc, 1, y, 1, 1, 1,
						0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		GridBagLayoutManager.addComponent(content, Box.createGlue(), gc, 0, ++y,
				2, 1, 1, 1, GridBagConstraints.BOTH, GridBagConstraints.WEST);
	...
	public Material getMaterial() {
		FinsMaterial mat = new FinsMaterial();
	...
	protected void fillSpecificComponents(Material material) {
		FinsMaterial mat = (FinsMaterial) material;
