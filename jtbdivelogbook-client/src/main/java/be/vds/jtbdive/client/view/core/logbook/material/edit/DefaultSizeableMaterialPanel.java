...
public class DefaultSizeableMaterialPanel extends AbstractMaterialPanel {
	private static final long serialVersionUID = 3995239127212556226L;
	private MaterialType materialType;
	private JTextField sizeTf;

	public DefaultSizeableMaterialPanel(MaterialType materialType) {
		super();
	...
	public Material getMaterial() {
		DefaultSizeableMaterial mat = new DefaultSizeableMaterial(materialType);
	...
	protected void fillSpecificComponents(Material material) {
		DefaultSizeableMaterial m = (DefaultSizeableMaterial) material;
		sizeTf.setText(m.getSize());
	}
