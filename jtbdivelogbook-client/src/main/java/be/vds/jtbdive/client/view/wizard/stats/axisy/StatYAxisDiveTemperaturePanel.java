...
public class StatYAxisDiveTemperaturePanel extends WizardPanel {

	private static final long serialVersionUID = -6569532577591094055L;


	@Override
	public String getMessage() {
		return i18n.getString("wizard.stat.temperatures");
	}
