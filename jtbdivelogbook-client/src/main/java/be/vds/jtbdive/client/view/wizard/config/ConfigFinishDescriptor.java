...
public class ConfigFinishDescriptor extends WizardPanelDescriptor {

	public static final String IDENTIFIER = "CONFIG_FINISH_PANEL";
	private static String backIdentifier;
	private ConfigFinishPanel panel;

	public ConfigFinishDescriptor() {
		panel = new ConfigFinishPanel();
