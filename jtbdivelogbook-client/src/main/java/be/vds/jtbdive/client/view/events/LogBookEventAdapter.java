...
public class LogBookEventAdapter implements LogBookEventListener {
...
//
	...
	@Override
	public void pinablesSelected(List<PinableObject> objects) {
	}

	@Override
	public void pinableSelected(PinableObject objects) {
	}
}
