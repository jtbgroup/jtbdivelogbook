...
public class AboutWindow extends JWindow {
	...
	private JComponent createContentPane() {
		JPanel p = new JPanel();
		p.setBorder(new LineBorder(UIAgent.getInstance()
				.getColorDetailPanelTop()));
	...
	private JComponent createLogoPane() {
		...
		GridBagLayoutManager.addComponent(panel, createJtbLogo(), c, 0, 0, 1,
				1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);

		GridBagLayoutManager.addComponent(panel, Box.createHorizontalGlue(), c,
				1, 0, 1, 1, 1, 1, GridBagConstraints.HORIZONTAL,
				GridBagConstraints.EAST);

		GridBagLayoutManager.addComponent(panel, createVersion(), c, 2, 0, 1,
				1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		return panel;
	}
	...
	private JComponent createJtbLogo() {
		JLabel label = new JLabel(ResourceManager.getInstance().getImageIcon(
				"logos/logo_125.png"));
		return label;
	}
	...
	private JComponent createProgrammingTeamPanel() {
		...
		StringBuffer sb = new StringBuffer();
		sb.append("<html>");
		sb.append("<p align='center'><font size='6'><b>")
				.append("Programming team").append("</b></font></p>");
		sb.append("<p align='center'>").append("Gautier Vanderslyen (CMAS 3*)")
				.append("</p>");
		sb.append("<p align='center'>")
				.append("Laurent Joppart (CMAS Monitor 3*)").append("</p>");

		sb.append("<p align='center'>")
				.append("http://jtbdivelogbook.sourceforge.net").append("</p>");
