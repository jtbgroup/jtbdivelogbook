 ...
 */
public class UwatecCurrentStatus
{
	private final int remainingBattery;
	private final int totalDiveNumbers;
	private final int logBookOffset;
	private final int numberOfDiveProfiles;
	private final int endOfProfileBuffer;
	private final Date currentTime;
	private final int checkSum;


    public UwatecCurrentStatus (int [] bytes)
    {
    ...
    public int getTotalDiveNumbers() {
		return totalDiveNumbers;
	}
    public int getNumberOfDiveProfiles() {
		return numberOfDiveProfiles;
	}
    public int getEndOfProfileBuffer() {
		return endOfProfileBuffer;
	}
}
