...
public class DiveComputerEquipment extends AbstractEquipment {

	private static final long serialVersionUID = -1137089883872923632L;
	...
	public MaterialType getMaterialType() {
		return MaterialType.DIVE_COMPUTER;
	}
